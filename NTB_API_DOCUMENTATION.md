...
User fills form and submits
    ↓
Call API: POST https://dev.kalen.co.tz/api/user/update-profile
    ↓
...
### Get User Profile
**Endpoint:** `GET https://dev.kalen.co.tz/api/user_profile`
...
### Update User Profile
**Endpoint:** `POST https://dev.kalen.co.tz/api/user/update-profile`
...
**Endpoint:** `POST https://dev.kalen.co.tz/api/ntb/create-with-files`
...
**Endpoint:** `GET https://dev.kalen.co.tz/api/ntb/list`
...
**Endpoint:** `GET https://dev.kalen.co.tz/api/ntb/{id}`
...
**Endpoint:** `GET https://dev.kalen.co.tz/api/ntb/types`
...
**Endpoint:** `GET https://dev.kalen.co.tz/api/ntb/report/web/feedback?tracking_code={code}`
...
const response = await fetch('https://dev.kalen.co.tz/api/ntb/create-with-files', {
  method: 'POST',
  headers: {
...
### Get NTB List
```javascript
const response = await fetch('https://dev.kalen.co.tz/api/ntb/list', {
  method: 'GET',
  headers: {
    'Authorization': 'Bearer your-token-here'
  }
...
### Get NTB Details
```javascript
const response = await fetch('https://dev.kalen.co.tz/api/ntb/123', {
  method: 'GET',
  headers: {
    'Authorization': 'Bearer your-token-here'
  }
...
### Get NTB Types
```javascript
const response = await fetch('https://dev.kalen.co.tz/api/ntb/types', {
  method: 'GET'
});
...
### Get NTB Feedback
```javascript
const response = await fetch('https://dev.kalen.co.tz/api/ntb/report/web/feedback?tracking_code=NTB-2024-001234', {
  method: 'GET',
  headers: {
    'Authorization': 'Bearer your-token-here'
  }
...
### Get User Profile
```javascript
const response = await fetch('https://dev.kalen.co.tz/api/user_profile', {
  method: 'GET',
  headers: {
    'Authorization': 'Bearer your-token-here'
  }
...
### Update User Profile
```javascript
const response = await fetch('https://dev.kalen.co.tz/api/user/update-profile', {
  method: 'POST',
  headers: {
    'Authorization': 'Bearer your-token-here',
    'Content-Type': 'application/json'
