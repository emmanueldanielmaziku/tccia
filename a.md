...
## Overview
This document records the NTB endpoints used by the frontend, together with the exact request payloads and response shapes observed in the current integration environment (`https://dev.kalen.co.tz`).
